...
- Python ≥3.13.2 + pylocal-akuvox ≥0.2.0 (schedule/user (003-schedule-user-services)
- None; integration is a pass-through to device local API (003-schedule-user-services)
...
## Recent Changes
- 003-schedule-user-services: Added Python ≥3.13.2 + pylocal-akuvox ≥0.2.0 (schedule/user
- 003-schedule-user-services: Added Python ≥3.13.2 + pylocal-akuvox ≥0.2.0 (schedule/user
